      ...
      <div className='flex grow flex-col gap-4'>
        ...
        <div className='flex justify-end'>
          <Link
            ...
            className='group inline-flex items-center gap-1.5 rounded-md border border-blue-300 bg-white px-4 py-2 text-sm font-semibold text-blue-600 transition-colors hover:border-blue-400 hover:bg-blue-50 focus-visible:ring-2 focus-visible:ring-blue-500/60 focus-visible:ring-offset-2 focus-visible:outline-none dark:border-blue-500/40 dark:bg-transparent dark:text-blue-300 dark:hover:border-blue-400/60 dark:hover:bg-blue-500/10 dark:focus-visible:ring-blue-400/60 dark:focus-visible:ring-offset-gray-950'
          >
            {t.cta.viewAll}
            <ArrowRight
              aria-hidden
