...
const ActivityBadge: FC<Props> = ({ activity, locale, label }) => (
  <Link
    ...
    className='text-caption inline-flex max-w-50 items-center gap-1.5 rounded-full border border-blue-200 bg-blue-50 px-2 py-0.5 font-medium text-blue-700 transition-colors hover:bg-blue-100 dark:border-blue-500/25 dark:bg-blue-500/10 dark:text-blue-200 dark:hover:bg-blue-500/20'
  >
