...
_only_ cast at index creation and query time. This preserves precision on disk
...
embedding-model swaps) _can_ regress on a specific corpus. Vendor and paper
